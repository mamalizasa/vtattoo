    ...
    <main id="toTop">
        <section>
            ...
            <form class="form" id="form" method="POST" >
                <label for="name_input">Ваше имя<span style="color: red;">*</span></label>
                <input id="name_input" class="inputsu _req" type="text" name="name" placeholder="Имя">
                <div class='name_div'></div>
                <label for="email_input">Ваша почта<span style="color: red;">*</span></label>
                ...
                <span class="little">Пароль должен состоять из латинских букв строчного и заглавного регистра, от 8 до 20 символов</span>

  
                <button type="submit" id="zapis" class="knopa">Зарегистрироваться</button>
                <span class="ili">Или <a class="sslk" href="login.php">Войти</a></span>
                <span class="little">Нажимая на кнопку "Зарегистрироваться", вы принимаете условия пользовательского соглашения</span>
              </form>
        </section>
    </main>
    <footer>
